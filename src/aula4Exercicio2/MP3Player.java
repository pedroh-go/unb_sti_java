...
public class MP3Player implements FormatoAudio{
	...
	public void mensagemStatus() {
		...
		switch (this.statusAudio) {
			case 1:
				System.out.println("Música MP3: "+getArquivo()+" está sendo reproduzida <> ");
				break;
			case 2:
				System.out.println("Música MP3: "+getArquivo()+" está pausado =");
				break;
			default:
				System.out.println("Música MP3: "+getArquivo()+" está parado");
				break;
		}
	}
